...
int main(void) {
    ...
    // Test case 1
    if (linked_list_insert_after_node_number(&list, 0, &first_node) != 0) {
    ...
    // Test case 2
    if (linked_list_insert_after_node_number(&list, 1, &second_node) != 0) {
        pthread_mutex_destroy(&list.linked_list_mutex);
    ...
    // Test case 3
    if (linked_list_insert_after_node_number(&list, 1, NULL) == 0) {
        pthread_mutex_destroy(&list.linked_list_mutex);
    ...
    // Test case 4
    if (linked_list_insert_after_node_number(NULL, 0, &third_node) == 0) {
        pthread_mutex_destroy(&list.linked_list_mutex);
    ...
    // Test case 5
    if (linked_list_insert_after_node_number(NULL, 0, NULL) == 0) {
        pthread_mutex_destroy(&list.linked_list_mutex);
